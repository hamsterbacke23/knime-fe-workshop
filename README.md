...
1. Click the following link, sign in via GitHub: [![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/fork/github/jschroeter/knime-fe-workshop)
2. When you see the IDE, click "Create a repository" on the top left to fork the repo and connect the IDE to the new repo.
3. Accept prompts to install recommended VS Code extensions, most importantly [Vue - Official Language Support](https://marketplace.visualstudio.com/items?itemName=vue.volar)
4. After some time you should see the app homepage on the right side. You can ignore the "Unsupported engine" warnings in the terminal.
